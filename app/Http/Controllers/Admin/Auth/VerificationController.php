...
class VerificationController extends Controller
{
    ...
    */
    ...
    {
        if (! hash_equals((string) $request->route('id'), (string) $request->user('admins')->getKey())) {
            throw new AuthorizationException;
        }

        if (! hash_equals((string) $request->route('hash'), sha1($request->user('admins')->getEmailForVerification()))) {
            throw new AuthorizationException;
        }
