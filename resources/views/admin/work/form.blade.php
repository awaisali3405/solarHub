                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form form-vertical" action="{{ $action }}" method="POST"
                                ...
                                <div class="mb-3">
                                    <label for="name" style="margin-bottom: 10px;">Employee Name</label>
                                    <input type="text" id="name" class="form-control" name="name"
                                        value="{{ $employee->name }}" placeholder="Enter Name" readonly>
                                ...
                                <div class="mb-3">
                                    <label for="name" style="margin-bottom: 10px;">Quantity</label>
                                    <input type="text" id="name" class="form-control" name="quantity" value=""
