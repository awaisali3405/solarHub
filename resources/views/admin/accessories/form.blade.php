                            ...
                            <form class="form form-vertical" action="{{ $action }}" method="POST"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="name" class="form-control" name="name"
                                        value="{{ old('name', $accessories->name) }}" placeholder="Enter Name" required>
                                ...
                                <div class="mb-3">
                                    <label for="watt" style="margin-bottom: 10px;">watt</label>
                                    <input type="text" id="watt" class="form-control" name="watt"
                                        value="{{ old('watt', $accessories->watt) }}" placeholder="Enter watt" required>
                                ...
                                <div class="col-12 d-flex justify-content-end">
                                    <button type="submit" class="btn btn-primary me-1 mb-1">
                                        {{ $accessories->id != 0 ? 'Save Changes' : 'Submit' }}
                                    </button>
                                    @if ($accessories->id != 0)
