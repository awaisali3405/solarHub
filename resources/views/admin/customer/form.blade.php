                            ...
                            <form class="form form-vertical" action="{{ $action }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="name" class="form-control" name="name"
                                        value="{{ old('name', $customer->name) }}" placeholder="Enter name of customer"
                                        required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="cnic" class="form-control" name="cnic"
                                        value="{{ old('cnic', $customer->cnic) }}" placeholder="Enter Business Name"
                                        required>
                                ...
                                <div class="col-12 d-flex justify-content-end">
                                    <button type="submit" class="btn btn-primary me-1 mb-1">
                                        {{ $customer->id != 0 ? 'Save Changes' : 'Submit' }}
                                    </button>
                                    @if ($customer->id != 0)
