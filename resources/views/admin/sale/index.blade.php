        ...
        <div class="content-wrapper">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.sale.edit', 0) }}"><button class="btn btn-success">Add New
                            Sale</button></a>
                            ...
                            <tbody>
                                @forelse($sale as $key => $value)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.sale.edit', $value->id) }}" title="Edit"><i
                                                    style="font-size: 1.5rem" class="mdi mdi-table-edit"></i></a>
                                            <a href={{ route('admin.sale.show', $value->id) }}" title="Delete"
