                        ...
                        <div class="card-body">
                            <form id="cart" action="{{ $action }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row text-center mx-auto">
                                    ...
                                    <div class="col-xl-3 mt-2">
                                        <div class="form-group mx-3">
                                            <select class="form-control " name="customer_id" id="name_suppler"
                                                required="">
                                                <option value="">Select</option>
                                                @foreach ($supplier as $value)
                                                    <option value={{ $value->id }}
                                                        {{ $value->id == $sale->customer_id ? 'selected' : '' }}>
                                                        {{ $value->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <table name="cart table  responsive text-center">
                                    ...
                                    <tbody class="products">
                                        <tr style="margin-bottom: 20px;">
                                            <td colspan="99" class="mb-3"><span
                                                    class="row-add btn btn-primary px-3 float-end" id="add_sale_product">Add
                                                </span></td>
                                        </tr>
                                        <tr class="mt-5">
                                            <td></td>
                                    ...
                                    <tbody class="product">
                                        @forelse ($sale->product as $key=>$value)
                                    ...
                                    <tr>
                                        ...
                                        <td> <input type="text" name="total" id="grandtotal" class="form-control"
                                                value="{{ $sale->total }}" jautocalc="({ftotal}+({ftotal} * {wht})/100)"
                                                readonly="readonly" _jautocalc="_jautocalc"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input type="number" step="any" name="discount" id="discount"
                                                value="{{ $sale->discount }}" class="form-control"
                                        ...
                                        <td>
                                            ...
                                            <input type="number" step="any" name="gst_tax" id="gst"
                                                value="{{ $sale->gst_tax }}" class="form-control"
                                        ...
                                        <td>
                                            ...
                                            <input type="number" step="any" name="wht_tax" id="wht"
                                                value="{{ $sale->wht_tax }}" class="form-control"
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <select class="form-control mx-auto" name="status" id="status_id"
                                                required="">
                                                <option value="unpaid" {{ $sale->status == 'unpaid' ? 'selected' : '' }}>
                                                    UnPaid
                                                </option>
                                                <option value="paid" {{ $sale->status == 'paid' ? 'selected' : '' }}>
                                                    Paid
                                                </option>
